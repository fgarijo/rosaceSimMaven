...
import org.icaro.aplicaciones.Rosace.informacion.Coste;
...
import org.icaro.aplicaciones.recursos.recursoVisualizadorEntornosSimulacion.imp.LineaObstaculo;
...
import org.icaro.infraestructura.entidadesBasicas.procesadorCognitivo.Temporizador;
...
//         estadoActual.inicializarInfoMovimiento(this.energiaInicialRobot, robotposicionActual, this.velocidadRobot);
    ...
    @Override
	public synchronized void cambiaDestino(String identDest,org.icaro.aplicaciones.Rosace.informacion.Coordinate coordDestino) {
