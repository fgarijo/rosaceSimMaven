...
public class Victim implements Serializable, Cloneable {
    ...
    public Coordinate getCoordinateVictim() {
        if (coordinateVictim == null) {
            coordinateVictim = new Coordinate(0, 0, 0);
        }
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        if (this.coordinateVictim == null) {
            this.coordinateVictim = new Coordinate(victimCoordinateP.x, victimCoordinateP.y, 0);
        }
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        if (this.coordinateVictim == null) {
            this.coordinateVictim = new Coordinate(0, 0, 0);
        }
        coordinateVictim.setX(victimCoordinateP.x);
        coordinateVictim.setY(victimCoordinateP.y);
