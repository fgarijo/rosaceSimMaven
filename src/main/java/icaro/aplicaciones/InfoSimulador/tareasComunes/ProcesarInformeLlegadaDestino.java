...
//Suponemos que cuando llega al destino se salva la victima
            ...
            // El robot esta parado, por tanto no hace falta el thread para dar la orden
            ...
            victims.getVictimARescatar(victimaRescatadaId).setRescued();
            ...
            trazas.aceptaNuevaTrazaEjecReglas(this.identAgente, " Se Procesa el informe   recibido por el agente :" + identAgente + "\n"
                    ...
                    + "  El foco esta en el objetivo :  " + objetivoFocalizado + "\n");
            ...
            if (objetivoFocalizado == null || objetivoFocalizado.getState() == Objetivo.SOLVED
                    || misObjsAccion.existeObjetivoConEsteIdentRef(objetivoFocalizado.getobjectReferenceId())) {
            ...
            } // Si esta en un proceso de decision no se cambia el foco para que continue con el proceso de decision
    ...
    private void informarControladorRescateVictima(String idVictimaAsignada, InfoEquipo miEquipo) {
        ...
        InfoAgteVictimaRescatada infoVictimaRescatada = new InfoAgteVictimaRescatada(this.identAgente, idVictimaAsignada, tiempoActual, gastoEnergia);
