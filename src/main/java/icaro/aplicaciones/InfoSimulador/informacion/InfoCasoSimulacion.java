...
//       intervaloSecuencia = intervSecuencia;
    ...
    public synchronized int getNumeroVictimasRescatadas() {
        return identsVictimasRescatadas.getVictimas().size();
    }
...
//            if (!identsVictimasRescatadas.getVictimas().contains(idVictima)){
//            if (!idVictima.equals(conjVictimasRescatadas.last().getvictimaId())) {
                identsVictimasRescatadas.addVictima(idVictima);
