 ...
 */
package icaro.aplicaciones.agentes.RbAsignadorTareasCognitivo.informacion;
...
public class InfoParaDecidirAQuienAsignarObjetivo implements Serializable {
        ...
        try {
            if (identEquipo != null) {
                ...
                for (int i = 0; i < agentesAplicacionDefinidos.size(); i++) {
                    ...
                    {
                        if (identEquipo.equals(VocabularioRosace.IdentEquipoJerarquico)) {
    ...
    public synchronized void addConfirmacionAcuerdoParaIr(String idAgenteEmisorRespuesta, String respuesta) {
        ...
        if ("".equals((String) confirmacionesAgentes.get(indiceAgenteEmisorRespuesta))) {
    ...
    public synchronized void addNuevaEvaluacion(EvaluacionAgente evaluacion) {
        ...
        if (indiceAgente != -1) {
            ...
            } else if (eval == valorMejorEvalucionRecibida) {
                hayEmpates = true;
            }
