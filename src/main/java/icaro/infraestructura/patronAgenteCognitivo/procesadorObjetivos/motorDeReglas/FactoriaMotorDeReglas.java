...
import icaro.infraestructura.patronAgenteCognitivo.procesadorObjetivos.motorDeReglas.imp.FactoriaMotorDeReglasDroolsImp6;
    ...
    public static FactoriaMotorDeReglas instance(){
        if(instance==null){
            String c = System.getProperty(NombresPredefinidos.RUTA_FACTORIA_MOTOR_REGLAS,
                    FactoriaMotorDeReglasDroolsImp6.class.getName());
            try{
