...
//	public static final String ESTADO_TERMINADO = "terminado";
    ...
    protected String accionEjecutada;
...
//        protected String propietario;
     ...
     * @param nivelTraza Profundidad de las trazas (usar constantes definidas
     * estticas en esta clase)
     */
        ...
        if (tipoTransicion == NombresPredefinidos.AUTOMATA_EF_TIPO_TRANSICION_METODO_AS_BLOQ
            ...
            if (metodoId != null) {
                try {
                    ...
                    accionEjecutada = "\n Clase : " + accion.getSimpleName() + " \n Parametros : " + this.paramsAccionToString(params);
                    return true;
                } catch (Exception ex) {
                    java.util.logging.Logger.getLogger(InterpreteAutomataEFconGestAcciones.class.getName()).log(Level.SEVERE, null, ex);
                    return false;
...
//        @Override
    ...
    private String paramsAccionToString(Object[] parametros) {
        String listaParametros = "";
        if (parametros == null || (parametros.length == 1 && parametros[0] == null)) {
//                    params = new Class[0];
            listaParametros = "\n" + " Sin parametros ";
//                    paramsObj = new Object[0];
        } else {
            for (int i = 0; (i < parametros.length); i++) {
                listaParametros = listaParametros + "\n" + " Clase : " + parametros[i].getClass().getSimpleName();
                listaParametros = listaParametros + "\n" + " Objeto : " + parametros[i];
            }
