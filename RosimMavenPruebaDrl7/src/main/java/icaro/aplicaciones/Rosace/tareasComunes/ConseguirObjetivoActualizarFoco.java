...
////                if (misObjs.existeObjetivoConEsteIdentRef(objetivoConseguido.getobjectReferenceId()) )misObjs.eliminarObjetivo(objetivoConseguido);
                misObjs.addObjetivo(objetivoConseguido);
                if (focoActual != null ){
